...
\begin{figure}[!t]
	\centering
	% Requires \usepackage{graphicx}
	\subfigure[]{\resizebox*{4.3cm}{!}{\includegraphics{fitted_bgjnd_bg}}}
	\subfigure[]{\resizebox*{4.3cm}{!}{\includegraphics{fitted_bgjnd_e}}}
	\subfigure[]{\resizebox*{4.3cm}{!}{\includegraphics{fitted_bgjnd_depth}}}
